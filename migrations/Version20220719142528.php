 ...
 */
final class Version20220719142528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX volunteering_name_idx ON volunteering_type (name)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX volunteering_name_idx ON volunteering_type');
