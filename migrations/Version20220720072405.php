 ...
 */
final class Version20220720072405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE experience (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, volunteering_type_id INT DEFAULT NULL, reception_structure_id INT DEFAULT NULL, title VARCHAR(100) NOT NULL, slug_title VARCHAR(100) NOT NULL, country VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, year YEAR, duration timestamp, feedback LONGTEXT NOT NULL, views INT UNSIGNED DEFAULT 0 NOT NULL, picture VARCHAR(64) DEFAULT \'0.png\' NOT NULL, participation_fee INT UNSIGNED NOT NULL, is_hosted VARCHAR(64) NOT NULL, is_fed VARCHAR(64) NOT NULL, language LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', created_at timestamp default current_timestamp, updated_at timestamp default current_timestamp on update current_timestamp, INDEX IDX_590C103A76ED395 (user_id), INDEX IDX_590C10349AC5322 (volunteering_type_id), INDEX IDX_590C1034DFB40A2 (reception_structure_id), INDEX search_idx (country, city), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, user_sender_id INT DEFAULT NULL, user_receiver_id INT DEFAULT NULL, message LONGTEXT NOT NULL, is_read TINYINT(1) DEFAULT 0 NOT NULL, created_at timestamp default current_timestamp, updated_at timestamp default current_timestamp on update current_timestamp, INDEX IDX_B6BD307FF6C43E79 (user_sender_id), INDEX IDX_B6BD307F64482423 (user_receiver_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE thematic (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(64) NOT NULL, slug_name VARCHAR(64) NOT NULL, created_at timestamp default current_timestamp, updated_at timestamp default current_timestamp on update current_timestamp, UNIQUE INDEX UNIQ_7C1CDF725E237E06 (name), UNIQUE INDEX UNIQ_7C1CDF72C6E66724 (slug_name), INDEX thematic_name_idx (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, pseudo_slug VARCHAR(30) NOT NULL, firstname VARCHAR(64) NOT NULL, lastname VARCHAR(64) NOT NULL, age DATETIME NOT NULL, profile_picture VARCHAR(64) DEFAULT \'0.png\' NOT NULL, email VARCHAR(180) NOT NULL, phone VARCHAR(255) DEFAULT NULL, biography VARCHAR(250) DEFAULT NULL, native_country VARCHAR(255) NOT NULL, created_at timestamp default current_timestamp, updated_at timestamp default current_timestamp on update current_timestamp, UNIQUE INDEX UNIQ_8D93D64986CC499D (pseudo), UNIQUE INDEX UNIQ_8D93D649FF5E4F86 (pseudo_slug), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX native_country_idx (native_country), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE volunteering_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(64) NOT NULL, slug_name VARCHAR(64) NOT NULL, created_at timestamp default current_timestamp, updated_at timestamp default current_timestamp on update current_timestamp, UNIQUE INDEX UNIQ_D98742C95E237E06 (name), UNIQUE INDEX UNIQ_D98742C9C6E66724 (slug_name), INDEX volunteering_name_idx (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
