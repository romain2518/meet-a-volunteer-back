...
/**
 * @Route("/back/reception/structure")
 */
class ReceptionStructureController extends AbstractController
{
     ...
     */
    public function new(Request $request, ReceptionStructureRepository $receptionStructureRepository): Response
    {
     ...
     */
    public function edit(Request $request, ReceptionStructure $receptionStructure, ReceptionStructureRepository $receptionStructureRepository): Response
    {
        $form = $this->createForm(ReceptionStructureType::class, $receptionStructure);
        $form->handleRequest($request);
